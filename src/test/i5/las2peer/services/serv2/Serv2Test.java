 ...
 * 7009 - Test Class
 *
 * This class provides a basic testing framework for the microservice 7009. It was
 * generated by the CAE (Community Application Framework).
 *
 */
public class Serv2Test {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Serv2.class.getCanonicalName(),"0.1");
  ...
  public void testsongs() {
    ...
    try {
      ...
      System.out.println("Result of 'testsongs': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
